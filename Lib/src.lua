...
function library:Notify(title, text, duration)
	...
	local notifContainer = Instance.new("Frame", coregui)
	...
	notifTop.Name = "TopBar"
	notifTop.Size = UDim2.fromOffset(250, 3)
	...
	notifTitle.Size = UDim2.fromOffset(240, 18)
	notifTitle.Position = UDim2.fromOffset(5, 5)
	notifTitle.BackgroundTransparency = 1
	notifTitle.BorderSizePixel = 0
	notifTitle.Font = library.theme.font
	...
	notifContent.Size = UDim2.fromOffset(240, 30)
	notifContent.Position = UDim2.fromOffset(5, 26)
	notifContent.BackgroundTransparency = 1
	notifContent.BorderSizePixel = 0
	notifContent.Font = library.theme.font
	notifContent.Text = text or ""
	notifContent.TextColor3 = library.theme.itemscolor
	...
	local slideInTween = tweenservice:Create(notifContainer, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		Position = UDim2.fromScale(1, 0.1) - UDim2.fromOffset(260, 0)
	})
	slideInTween:Play()
	
	-- Animation sortie après duration
	task.wait(duration)
	local slideOutTween = tweenservice:Create(notifContainer, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
...
function library:CreateNotification(title, text, duration)
	self:Notify(title, text, duration)
end
